...
@requires_cache
def dataset_import(
    cache, user, user_job_id, project_id, dataset_uri, short_name=None, extract=False, timeout=None,
):
...
@requires_cache
def dataset_add_remote_file(cache, user, user_job_id, project_id, create_dataset, commit_message, short_name, url):
    ...
    try:
        ...
        with chdir(project.abs_path):
            ...
            add_file(urls, short_name, create=create_dataset, commit_message=commit_message)
